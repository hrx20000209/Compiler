...
public class calcParser extends Parser {
	...
	public static class CalculatorContext extends ParserRuleContext {
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof calcVisitor ) return ((calcVisitor<? extends T>)visitor).visitCalculator(this);
	...
	public static class LineContext extends ParserRuleContext {
		...
		public TerminalNode RET() { return getToken(calcParser.RET, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof calcVisitor ) return ((calcVisitor<? extends T>)visitor).visitLine(this);
			else return visitor.visitChildren(this);
		}
	}
